...
class GenerarSalariosRealesUseCase:
    """
    Caso de uso para generar un PDF de salarios con datos reales de trabajadores.
    """

    async def execute(self, trabajadores: List[Dict[str, Any]]) -> bytes:
        """
        Ejecuta el caso de uso para generar el PDF de salarios con datos reales.
